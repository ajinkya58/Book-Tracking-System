...
public class ReturnBook extends javax.swing.JFrame {
    ...
    //fetch  issue book details from database and  display it.
    ...
    public void getIssueBookDetails(){
        ...
        try{
            ...
            if(rs.next()){
                ...
                lbl_bookError2.setText("");
                
            }else{
                lbl_bookError2.setText("No record found!");
    ...
    private void initComponents() {
        ...
        lbl_bookError2.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        lbl_bookError2.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(lbl_bookError2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 710, 310, 40));
        ...
        lbl_issueId.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        lbl_issueId.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(lbl_issueId, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 290, 210, 40));

        lbl_bookName.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        lbl_bookName.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(lbl_bookName, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 370, 210, 40));

        lbl_studentName.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        lbl_studentName.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(lbl_studentName, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 450, 210, 40));
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 550, -1, -1));

        lbl_issueDate.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        lbl_issueDate.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(lbl_issueDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 530, 210, 40));

        lbl_dueDate.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        lbl_dueDate.setForeground(new java.awt.Color(255, 255, 255));
        jPanel1.add(lbl_dueDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 600, 210, 40));

        panel_main.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 0, 380, 810));
        ...
        panel_main.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(1550, 100, 300, -1));
        ...
        panel_main.add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(1490, 170, 360, 10));
        ...
        panel_main.add(txt_studentId, new org.netbeans.lib.awtextra.AbsoluteConstraints(1510, 410, 400, -1));
        ...
        panel_main.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(1410, 240, 80, 80));
        ...
        panel_main.add(txt_bookId, new org.netbeans.lib.awtextra.AbsoluteConstraints(1510, 260, 400, -1));
        ...
        panel_main.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(1390, 390, 110, 80));
        ...
        panel_main.add(rSMaterialButtonCircle2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1590, 550, 180, 80));
        ...
        panel_main.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(1880, 0, -1, -1));
        ...
        panel_main.add(rSMaterialButtonCircle3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1580, 690, 180, 80));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/icons/icons/library-2.png"))); // NOI18N
        jLabel3.setText("jLabel3");
        panel_main.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 970, 790));

        getContentPane().add(panel_main, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1960, 800));

        setSize(new java.awt.Dimension(1955, 803));
